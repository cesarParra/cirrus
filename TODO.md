...
- [ ] Ability to define custom aliases
...
- [ ] Ability to conditionally run commands based on different contexts, including the output of the previous command
...
Packaging
- [x] Ability to release new versions of packages
- [x] Ability to promote versions of packages
